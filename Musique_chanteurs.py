# -*- coding: utf-8 -*-
"""
Created on Sun Jul 25 13:07:05 2021
...
from questions import quiz_les_chanteurs
from questions import quiz_chanteurs_propositions
import random
...
class Window(QWidget):
    ...
    La réponse sera le chanteur de la musique jouée"""
    ...
    def __init__(self):
        ...
        self.musique= quiz_les_chanteurs[self.a]
        ...
        self.texte = QLabel("Quel est le chanteur de la musique suivante ?")
        ...
        self.bonnerep=QPushButton(quiz_chanteurs_propositions[self.a]['bonnerep'])
        self.prop2=QPushButton(quiz_chanteurs_propositions[self.a]['prop2'])
        self.prop3=QPushButton(quiz_chanteurs_propositions[self.a]['prop3'])
        self.prop4=QPushButton(quiz_chanteurs_propositions[self.a]['prop4'])
        
        self.play.setStyleSheet("background-color: darkgrey;font-size:18px;font-family:Times New Roman;")
        self.bonnerep.setStyleSheet("background-color: silver;font-size:18px;font-family:Times New Roman;")
        self.prop2.setStyleSheet("background-color: silver;font-size:18px;font-family:Times New Roman;")
        self.prop3.setStyleSheet("background-color: silver;font-size:18px;font-family:Times New Roman;")
        self.prop4.setStyleSheet("background-color: silver;font-size:18px;font-family:Times New Roman;")
        
        self.maliste=[self.bonnerep, self.prop2, self.prop3, self.prop4]
        
        self.next= QPushButton('Suivant')
        self.next.setStyleSheet("background-color: slategray;font-size:18px;font-family:Times New Roman;")
    ...
    def play_music(self):
        self.music=str(quiz_les_chanteurs[self.a]+'.mp3')
